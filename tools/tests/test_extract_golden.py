...
class GoldenOracleContractTests(unittest.TestCase):
    ...
    def test_exact_eight_build_by_eleven_boundary_oracle_succeeds(self):
        result, output = self.run_generator(self.valid_cases())
        self.assertEqual(result.returncode, 0, result.stderr)
        self.assertIn("88 vectors across 8 builds", output)

    def test_non_88_oracle_is_rejected_without_replacing_previous_output(self):
        ...
        self.assertIn("88", result.stderr)
