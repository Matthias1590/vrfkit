    ...
    where T : DamageParameters<T>
{
    ...
    public FVector? DamageOrigin { get; set; }
    ...
    protected void AddSharedFields()
    {
        ...
        AddPropertyHandle(6, x => x.DamageOrigin, ExportCategory.Gunplay)
            .Decode(ValorantPayloadDecoders.VectorNetQuantize100("DamageOrigin"));
